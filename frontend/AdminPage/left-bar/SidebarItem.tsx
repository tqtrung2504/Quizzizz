...
const SidebarItem: React.FC<SidebarItemProps> = ({ item, isActive, isExpanded, onClick }) => {
  ...
  const expandedClasses = `w-full px-2 sm:px-3 py-2 sm:py-2.5 justify-start text-xs sm:text-sm ${isActive ? 'bg-sky-600 text-white font-medium' : 'text-slate-300 hover:bg-slate-700/60 hover:text-sky-300 focus-visible:bg-slate-700/60 focus-visible:text-sky-300'}`;
